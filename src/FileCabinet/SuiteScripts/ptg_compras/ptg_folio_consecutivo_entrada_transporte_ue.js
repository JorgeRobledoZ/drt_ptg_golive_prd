    ...
    const beforeSubmit = (context) => {
        try {
            if (
                ...
                var searchEntradaTransporte = customrecord_ptg_entradatransporte_SearchObj.runPaged().count;
                ...
                currentRecord.setValue({
                    fieldId: "custrecord_ptg_folio_consecutivo_entrada",
                    value: "PTG - Entrada" + contador
                })
