    ...
    (file, https, log, record, render, runtime, search, url, drt_mapid_cm) => {
        ...
        const onRequest = (scriptContext) => {
            ...
            let getListStatusCallAlert = url.resolveScript({
          	...
          	let getMotivosReprogramacionCasos = url.resolveScript({
                scriptId: 'customscript_ptg_rl_get_mot_rep_casos',
            ...
            datasource.getHistorico = getHistorico
          	...
          	datasource.getMotivosReprogramacionCasos = getMotivosReprogramacionCasos
            
                        
            //Carga de View (html)
            let viewHtml = file.load({
                id: 'SuiteScripts/ptg_call_center_monitor_suitlet/view/monitor.html'
            });
