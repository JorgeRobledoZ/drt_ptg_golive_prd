            ...
            try {
                let transferorderSearchObj = search.create({
                    ...
                    filters: [
                        ...
                        "AND", 
                        ["custbody_ptg_numero_viaje_destino","anyof", requestBody.idNTravel], 
                        "AND", 
                        ["status","anyof","TrnfrOrd:F"], 
                        "AND", 
                        ["location.custrecord_ptg_ruta_cilindro_","is","T"]
                        // ["type", "anyof", "TrnfrOrd"],
                        // "AND",
                        // ["mainline", "is", "T"],
                        // "AND",
                        // ["taxline", "is", "F"],
                        // "AND",
                        // ["trandate", "within", "31/3/2022", "2/4/2022"],
                        // "AND",
                        // ["custbody_ptg_numero_viaje_destino", "anyof", "165"]
                    ],
                    columns: [
                        search.createColumn({
                            name: "internalid",
